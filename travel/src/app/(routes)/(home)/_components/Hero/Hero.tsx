...
function Hero() {
  ...
  return (
    <div className="relative bg-[url('/slider/bgswipe.jpg')] bg-cover bg-center min-h-[600px] z-0 py-16">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center z-10">
        {/* Left Section */}
